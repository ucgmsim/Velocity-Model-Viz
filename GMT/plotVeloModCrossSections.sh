...
BASECPT_VS_PLOT=Vs_Plot.cpt
BASECPT_VS_BAR=Vs_Bar.cpt
ZMIN=0.25
ZMAX=5.25
ZINC=0.01
...
# make CPT files (if necessary)
BASECPT_VP_PLOT=Vp_Plot.cpt
BASECPT_VP_BAR=Vp_Bar.cpt
ZMIN=1.5
ZMAX=9.5
ZINC=0.01
...
# make CPT files (if necessary)
BASECPT_RHO_PLOT=Rho_Plot.cpt
BASECPT_RHO_BAR=Rho_Bar.cpt
ZMIN=1.6
ZMAX=3.6
ZINC=0.01
